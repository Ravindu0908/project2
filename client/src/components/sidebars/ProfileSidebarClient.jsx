        ...
        <nav aria-label="side navigation" className="flex-1 overflow-auto">
          <div>
            <ul className="flex bg-pink-500 flex-1 flex-col gap-1 py-3">
              ...
              <li className="px-3">
                <a
                  href="/client/update-password"
                  className="flex items-center gap-3 rounded text-slate-200 transition-colors hover:bg-pink-50 hover:text-pink-500 focus:bg-pink-50 aria-[current=page]:bg-pink-50 aria-[current=page]:text-pink-500 "
                >
          ...
          <div className="p-3 text-white">
            ...
            {/* <p className="p-3 mx-10 text-green-500 font-bold rounded-2xl">
              Approved
            </p> */}
          </div>
        </nav>
