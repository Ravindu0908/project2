const Footer = () => {
  return (
    <footer>
      <div className="py-4 text-sm border-t border-pink-200 bg-pink-100">
        <div className="container px-6 mx-auto">
          <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
            <div className="col-span-2 md:col-span-4 lg:col-span-6">
              Copyright 2024 Ruby Beauty Palor
            </div>
            <nav
            ...
            >
              ...
              <ul className="flex items-center justify-end gap-4">
                <li>
                  <a
                    href="/"
                    className="transition-colors duration-300 hover:text-pink-600 focus:text-pink-700"
                  >
                    <svg
