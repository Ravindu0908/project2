...
const UpdateProduct = ({ product, closeUpdateProduct, getProducts }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`/admin/products/${product.productCode}`, data, {
        headers: {
  ...
  return (
    <div className="absolute z-10 top-5 mt-[-50px] bottom-5 h-[90vh] overflow-auto bg-white p-16 sm:mx-auto sm:w-full sm:max-w-4xl shadow-md rounded-xl transform hover:scale-103 duration-300 hover:shadow-lg">
